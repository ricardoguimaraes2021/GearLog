...
Route::prefix('v1')->group(function () {
    ...
    Route::post('/forgot-password', [AuthController::class, 'forgotPassword'])->middleware('throttle:5,1'); // 5 attempts per minute
    Route::post('/reset-password', [AuthController::class, 'resetPassword'])->middleware('throttle:5,1'); // 5 attempts per minute
    Route::get('/validate-reset-token', [AuthController::class, 'validateResetToken'])->middleware('throttle:10,1'); // 10 attempts per minute
    ...
    Route::middleware(['auth:sanctum', 'tenant'])->group(function () {
        ...
        Route::delete('/company/invites/{id}', [CompanyInviteController::class, 'destroy']);
